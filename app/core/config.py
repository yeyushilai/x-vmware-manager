...
class Settings:
    ...
    # VMware vSphere 配置
    VMWARE_HOST: str = os.environ.get('VMWARE_HOST', '')
    VMWARE_PORT: str = os.environ.get('VMWARE_PORT', '443')
    VMWARE_USERNAME: str = os.environ.get('VMWARE_USERNAME', '')
    VMWARE_PASSWORD: str = os.environ.get('VMWARE_PASSWORD', '')
